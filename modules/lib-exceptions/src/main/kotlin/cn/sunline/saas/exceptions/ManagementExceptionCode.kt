...
enum class ManagementExceptionCode(val code: Int) {
    ...
    PRODUCT_TERM_VALUE_IS_NOT_CORRECT(5006),
    PRODUCT_AMOUNT_VALUE_IS_NOT_CORRECT(5007),
    ...
    INTEREST_RATE_PERIOD_IS_NOT_NULL(5103),
    INTEREST_RATE_PERIOD_IS_NOT_CORRECT(5104),
    RATE_PLAN_DATA_ALREADY_EXIST(5105),
    INTEREST_RATE_DATA_ALREADY_EXIST(5106),

    // Http 5150 - 5199
    HTTP_ERROR(5151),

    //loan 5200 - 5299
    LOAN_UPLOAD_CONFIGURE_NOT_FOUND(5201),
    APPLICATION_ID_ALREADY_EXIST(5202),
    LOAN_APPLY_NOT_FOUND(5203),
    PRODUCT_TYPE_CANNOT_BE_CHANGE(5204),
    SUB_TYPE_IS_IRRELEVANT_PARENT_TYPE(5205),
    LOAN_APPLY_STATUS_CAN_NOT_BE_CHANGE(5206),
    SUBMIT_ERROR(5207),
    LOAN_HAS_BEEN_PRODUCT_TYPE(5208),
    ...
    INTEREST_FEATURE_NOT_FOUND(5603),
    ...
    REPAYMENT_INSTRUCTION_ALREADY_EXIST(5614),
    REPAYMENT_AGREEMENT_NOT_FOUND(5615),
    REPAYMENT_AGREEMENT_ALREADY_EXIST(5616),
    ...
    CHANNEL_COMMISSION_NOT_FOUND(5673),
    CHANNEL_DATA_ALREADY_EXIST(5674),
    CHANNEL_COMMISSION_AGREEMENT_ALREADY_EXIST(5675),
    CHANNEL_COMMISSION_AMOUNT_OR_RATIO_NOT_NULL(5676),
    CHANNEL_COMMISSION_CONFIG_MORE_THAN_ONE(5677),
    CHANNEL_ARRANGEMENT_ALREADY_EXIST(5678),

    //gateway 5700-5799
    GATEWAY_NETWORK_ERROR(5700),
    INSTANCE_NOT_FOUND(5701),
    ILLEGAL_INSTANCE_ID(5702),
    API_NOT_FOUND(5703),
    SERVER_NOT_FOUND(5704),

    //workflow 5800-5899
    PROCESS_DEFINITION_NOT_FOUND(5800),
    PROCESS_DEFINITION_ALREADY_EXIST(5801),
    PROCESS_DEFINITION_CODE_ERROR(5802),
    PROCESS_DEFINITION_UPDATE_ERROR(5803),
    ACTIVITY_DEFINITION_NOT_FOUND(5804),
    ACTIVITY_DEFINITION_ADD_ERROR(5805),
    ACTIVITY_DEFINITION_UPDATE_ERROR(5806),
    EVENT_DEFINITION_NOT_FOUND(5807),
    EVENT_TYPE_HAS_BEEN_USED(5808),
    PROCESS_STEP_NOT_FOUND(5809),
    ACTIVITY_STEP_NOT_FOUND(5810),
    EVENT_STEP_NOT_FOUND(5811),
