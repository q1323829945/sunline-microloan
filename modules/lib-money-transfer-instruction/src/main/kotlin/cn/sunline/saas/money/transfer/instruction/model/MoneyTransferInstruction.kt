...
class MoneyTransferInstruction(
    ...
    @Column(
        name = "money_transfer_instruction_type",
        nullable = false,
        length = 32,
    ...
    @NotNull
    @Column(
        name = "money_transfer_instruction_amount",
        nullable = false,
        scale = 19,
        precision = 2,
    ...
    @Enumerated(value = EnumType.STRING)
    @Column(
        name = "money_transfer_instruction_currency",
        nullable = false,
        length = 32,
        columnDefinition = "varchar(32) not null"
    )
    ...
    @Column(
        name = "money_transfer_instruction_purpose",
        nullable = true,
        length = 128,
    ...
    @Enumerated(value = EnumType.STRING)
    @Column(
        name = "money_transfer_instruction_status",
        nullable = false,
        length = 32,
        columnDefinition = "varchar(32) not null"
    )
