...
class MenuService {
    ...
    init {
        ...
        val eventHandle = Menu("eventHandle","businessHandling","","/dashboard/eventHandle",17)
        val eventHandleQuery = Menu("eventHandleQuery","businessQuery","","/dashboard/eventHandleQuery",18)
