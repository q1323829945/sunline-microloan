...
class EqualInstallmentCalculator : BaseRepaymentScheduleCalculator {
    ...
    override fun calRepaymentSchedule(dtoRepaymentScheduleCalculate: DTORepaymentScheduleCalculate): RepaymentSchedule {
        ...
        val repaymentInstallment =
            CalcRepaymentInstallmentComponent.calcCapitalInstallment(amount, loanRateMonth, periods, repaymentFrequency)
        ...
        for (i in 0 until periods) {
            ...
            if (nextRepaymentDateTime.compareTo(currentRepaymentDateTime.plusMonths(1 * repaymentFrequency.ordinal)) != 0) {
                interest = CalcInterestComponent.calcBaseInterest(
                ...
                // 本金计算
                principal = CalcPrincipalComponent.calcBasePrincipal(
            ...
            repaymentScheduleDetails += RepaymentScheduleDetail(
                ...
                period = i + 1,
                repaymentInstallment = CalcRepaymentInstallmentComponent.calcBaseRepaymentInstallment(
                    principal,
                    interest
                ),
                principal = principal,
    ...
    override fun calResetRepaymentSchedule(
        ...
        // 平均还款金额
        val repaymentInstallment = CalcRepaymentInstallmentComponent.calcCapitalInstallment(
            remainLoanAmount,
            loanRateMonth,
            periods,
            repaymentFrequency!!
        ...
        for (detail in repaymentScheduleDetail) {
            if (currentPeriod <= detail.period) {
                ...
                detail.repaymentInstallment =
                    CalcRepaymentInstallmentComponent.calcBaseRepaymentInstallment(principal, interest)
