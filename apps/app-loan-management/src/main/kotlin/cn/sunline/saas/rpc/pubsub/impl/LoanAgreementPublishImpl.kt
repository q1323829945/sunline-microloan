...
class LoanAgreementPublishImpl:LoanAgreementPublish {
    ...
    override fun addLoanApplicationDetailAndStatistics(DTOLoanApplicationDetail: DTOLoanApplicationDetail){
        PubSubService.publish(
            pubSubName = APP_LOAN_MANAGEMENT_PUB_SUB,
            topic = LoanAgreementPublishTopic.LOAN_APPLICATION_DETAIL_STATISTICS.toString(),
