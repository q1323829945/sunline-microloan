...
class LoanController {
    ...
    fun calculate(@PathVariable("productId") productId:Long, @PathVariable("amount") amount: BigDecimal, @PathVariable term: LoanTermType):ResponseEntity<DTOResponseSuccess<DTORepaymentScheduleTrialView>>{
